...
try:
    ...
    logger.warning("Prophet non installé — utilisation du fallback statistique")
...
class DemandPredictor:
    ...
    def train(self, real_data: Optional[list] = None) -> dict:
        ...
        logger.info(f"Entraînement Prophet pour {self.city}/{self.category}")
        ...
        self.model = Prophet(
            ...
            # Flexibilité de la saisonnalité
