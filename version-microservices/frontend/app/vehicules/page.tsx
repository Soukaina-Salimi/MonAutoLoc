  ...
  useEffect(() => {
    ...
    const fetchVehicles = async () => {
      try {
        ...
        const vehiclesData = res.data.map((v: any) => ({
          ...v,
          rating: v.reviews_avg_rating || null, // ← Utiliser la moyenne calculée
            ...
            <div className="flex flex-col lg:flex-row gap-4">
              ...
              <div className="flex gap-2">
                ...
                <motion.button
                  ...
                  className={`px-4 py-3 border rounded-xl flex items-center gap-2 transition-all duration-200 ${
                    isFilterOpen
                  ...
                  <div className="flex flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-6">
                      ...
                      <div className="flex items-center gap-4 mb-4">
                        ...
                        <div
                          className={`flex items-center text-sm ${vehicle.available ? "text-green-600" : "text-red-600"}`}
                        >
                          {vehicle.available ? (
                            <>
